#! /usr/bin/env bash
# add in verbosity along the way
read -p "Current codename? ie bullseye " oldrelease

read -p "New Debian codename? ie bookworm " newrelease
...
# possible solution is "sed" the old name out and new name in
